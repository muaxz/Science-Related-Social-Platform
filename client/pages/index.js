...
export async function getServerSideProps(context){
    ...
    try {
        ...
        var recieved = await Promise.all([axios.get(`https://ideasharee.herokuapp.com/content/gethome/0/6`),axios.get(`https://ideasharee.herokuapp.com/getCategories/true`)])
